...
#define WM_LISTCTRLEX_HEADERRIGHTCLICK			(WM_USER + 2000)
...
public:
	...
	CSysImageList m_sysImageList;	// Image type System window
	...
	CImageList* SetHeaderImageList(UINT nBitmapID, COLORREF crMask = RGB(255, 255, 255));
	...
	CImageList* SetImageList(UINT nBitmapID, COLORREF crMask = RGB(255, 255, 255));
	CImageList* SetImageList(CImageList* pImageList);
	CImageList* GetImageList() const;
};

class CListCtrlEx::CHeaderRightClick
{
public:
	int m_column;
	CPoint m_mousePos;
