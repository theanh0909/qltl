...
public:
	...
	static void GetFileList(const _tstring& strTargetDirectoryPath, const _tstring& strWildCard, 
		bool bLookInSubdirectories, vector<CString>& vecstrFileList);

	// Get folder of all folder in the target directory
	static void GetFolderList(const _tstring& strTargetDirectoryPath, vector<CString>& vecstrFolderList);
